...
1. Comunicación unidireccional:Los datos fluyen siempre de un componente padre a sus componentes hijos, nunca al revés.
2.Inmutabilidad:sLas props son de solo lectura; el componente hijo no puede cambiar los valores que recibe del padre.
