...
Los datos fluyen siempre de un componente padre a sus componentes hijos, nunca al revés.
2.Inmutabilidad:
Las props son de solo lectura; el componente hijo no puede cambiar los valores que recibe del padre.
